<?php
	...
	$consulta = "SELECT * FROM perifericos WHERE id = $id";
		...
		<center>
			...
			<table border="1" width="80%" style="font-size:13px">
				<tr>
					...
					<td width="50%"><?php echo $row["_dispositivos"]?></td>
				</tr>
			</table>
			<br>
			<table border="1" width="80%" style="font-size:13px">
